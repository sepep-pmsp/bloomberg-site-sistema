        ...
        <div className="flex flex-wrap justify-center gap-10">
            {cardItens.map(item => (
                <div key={item.id} className="group relative w-[300px] h-[40rem] flex items-start cursor-pointe justify-center overflow-hidden ">
                    ...
                    <div className="absolute top-44 left-8 h-1 group-hover:h-120 w-60 bg-[var(--green-600)] rounded-2xl  px-6 py-5 text-[var(--color-primary-light)] translate-y-[-80px] transition-all duration-500 ease-out group-hover: shadow-2xl flex flex-col justify-end overflow-y-auto">
            ...
            <img src={Vector} className='absolute w-full top-[163rem] -z-10 left-0 select-none pointer-events-none' />
            <div className='bg-[#CEFA05] w-32 h-[1.3rem] absolute right-[118rem] rotate-[155deg] select-none pointer-events-none' />
            <div className='bg-[#CEFA05] h-[1.3rem] absolute w-[115px] z-[-1] left-[1847px] top-[3019px] rotate-[244deg] select-none pointer-events-none' />
        </div>
    )
}