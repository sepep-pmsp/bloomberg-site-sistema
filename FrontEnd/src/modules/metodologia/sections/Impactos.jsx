    ...
    return (
        <div className='relative flex flex-col items-center justify-center pb-24'>
            ...
            <div className='flex flex-col gap-20 w-full' style={{ maxWidth: "1420px", height: "auto", margin: "0 auto" }}>
                ...
                <p className='2xl:!text-2xl !text-2xl select-none pointer-events-none z-10 !font-bold' dangerouslySetInnerHTML={{ __html: subtitle }}/>
                <Link to="/artigo-completo" className="btSaibaMais flex items-center">
            ...
            <div className='absolute top-100 w-full z-10 select-none pointer-events-none max-lg:hidden -translate-y-1/2'>
