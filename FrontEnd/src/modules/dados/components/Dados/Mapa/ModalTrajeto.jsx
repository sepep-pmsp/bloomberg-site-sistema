        ...
        <div className="w-sm lg:w-full h-full p-4 flex flex-col gap-4 animate-fade-in">
            ...
            <div className="flex-1 min-h-[450px] w-full rounded-xl overflow-hidden relative bg-[#e5e5e5]">
                ...
                <div className="absolute bottom-4 left-2 z-[20] bg-[#0A290F] text-[var(--green-50)] p-3 rounded-lg shadow-lg text-xs leading-relaxed" style={{ fontFamily: 'var(--font-body)' }}>
                    <h4><strong className="text-[var(--green-50)] !font-bold">Modelo:</strong> <span className='text-[var(--green-50)] !font-normal'>{bus.modelo}</span></h4>
                    ...
                    <h4><strong className="text-[var(--green-50)] !font-bold">CO₂:</strong> <span className='text-[var(--green-50)] !font-normal'>{bus.co2?.toLocaleString('pt-BR')} kg</span></h4>
                    <h4><strong className="text-[var(--green-50)] !font-bold">População:</strong> <span className='text-[var(--green-50)] !font-normal'></span></h4>
                </div>
            </div>
        </div>
    );
