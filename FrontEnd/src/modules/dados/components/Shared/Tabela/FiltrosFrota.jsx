...
export default function FiltrosFrota({ filters, setFilters, uniqueLines, uniqueModels, stats, popBounds }) {
    ...
    return (
        <div >
            ...
            <div className="bg-[#0A290F] text-white p-6 rounded-2xl mb-4 shadow-lg">
                <div className="mb-6">
                    <span className="bg-[#D6F5DB] text-[#0A290F] text-xs font-bold px-3 py-1 rounded-full">
                        *dados do dia 31/01
                    </span>
                </div>

                <div className="flex flex-col items-start lg:flex-row justify-between lg:items-center gap-8">
                    <div className="lg:col-span-5 space-y-2 w-1/5">
                        <label className="text-sm flex items-center gap-2">
                            <h3 className='!font-normal text-[var(--green-50)]'>Faixa de população afetada:</h3>
                        </label>
